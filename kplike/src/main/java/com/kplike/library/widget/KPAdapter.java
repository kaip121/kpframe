package com.kplike.library.widget;
 ...
 *
 * @author kaiping
 * @date 2016/5/18 11:16
 */
public abstract class KPAdapter<T> extends BaseAdapter implements AbsListView.OnScrollListener {
    ...
    public KPAdapter(AbsListView view, Collection<T> mDatas, int itemLayoutId) {
        if (mDatas == null) {
